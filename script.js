...
// write code here
let course101 = "CIS101";
console.log(course101);

let course102 = "CIS102";
console.log(course102);
...
//Because the first "2" is of type string, while the last 2 is integer
...
nums.push(1);
console.log("After push(1): ", nums); // [3, 1, 4, 1]

nums.unshift(9);
console.log("After unshift(9): ", nums); // [9, 3, 1, 4, 1]

nums.pop();
console.log("After pop(): ", nums); // [9, 3, 1, 4]

console.log("Final array: ", nums);
console.log("Final length: ", nums.length);
